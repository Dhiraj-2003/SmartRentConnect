    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/upload/**").authenticated() // Allow all authenticated users to upload files
                        .requestMatchers("/api/files/**").authenticated() // Allow all authenticated users to access file info
